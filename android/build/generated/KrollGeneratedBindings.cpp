...
namespace titanium {
	namespace bindings {
		...
		class CollectionReferenceBindings {
			public:
				static BindEntry* lookupGeneratedInit(const char*, unsigned int);
		};

		BindEntry* CollectionReferenceBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"firebase.firestore.TifirestoreModule", ::firebase::firestore::TifirestoreModule::bindProxy, ::firebase::firestore::TifirestoreModule::dispose},
				{"firebase.firestore.CollectionReferenceProxy", ::firebase::firestore::tifirebase::CollectionReferenceProxy::bindProxy, ::firebase::firestore::tifirebase::CollectionReferenceProxy::dispose}
			};
